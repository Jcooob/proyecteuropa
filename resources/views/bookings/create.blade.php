                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('bookings.store') }}" method="POST">
                        ...
                        <div>
                            ...
                            <input type="number" id="number_of_guests" name="number_of_guests" min="1" max="{{ $room->capacity }}" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                        </div>
                        <div class="mt-4">
                            <label for="starting_date" class="block text-sm font-medium text-gray-700">Fecha de entrada:</label>
                            <input type="date" id="starting_date" name="starting_date" min="{{ now()->format('Y-m-d') }}" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                        </div>
                        <div class="mt-4">
                            <label for="ending_date" class="block text-sm font-medium text-gray-700">Fecha de salida:</label>
                            <input type="date" id="ending_date" name="ending_date" min="{{ now()->format('Y-m-d') }}" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm">
                        </div>
                        <div class="mt-4">
                            <label for="total_days" class="block text-sm font-medium text-gray-700">Total de días:</label>
                            <input type="number" id="total_days" name="total_days" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" readonly>
                        </div>
                        <div class="mt-4">
                            <label for="total_price" class="block text-sm font-medium text-gray-700">Precio total:</label>
                            <div class="relative mt-1">
                                <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500">$</span>
                                <input type="number" id="total_price" name="total_price" class="block w-full pl-7 pr-12 border-gray-300 focus:border-indigo-500 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" readonly>
                            </div>
                        </div>
                        <div class="mt-4">
